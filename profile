...
if [[ $UNAME =~ ^(Linux|Darwin) ]]; then
   ...
   # for Cygwin and for Windows in general, there is no binary exe "python3". 
   # to make python3 working, make a link
   #    $ ln -s "/cygdrive/c/Program Files/Python312/python" "$SITEBASE/python3/Cygwin/bin/python3"
   ...
   export TP_P3_PATH="/c/Program Files/Python312:$SITEBASE/python3/MINGW/bin:/c/Program Files/Python312/scripts:/c/Users/$USERNAME/AppData/Roaming/Python/Python312/Scripts"
   export TP_P2_PATH="/c/Program Files/Python27:/c/Program Files/Python27/scripts"
